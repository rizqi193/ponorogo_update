        ...
        <?php else: ?>
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('profile')); ?>">Data Warga</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('about')); ?>">Data RT/RW</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('contact')); ?>">Data Surat</a>
                    </li>
...
<?php /**PATH C:\Users\ASUZ R1 19\Documents\aplikasi_web1\resources\views/components/menu.blade.php ENDPATH**/ ?>